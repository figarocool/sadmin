...
<body style="background: url('../w-admin/immagini/sfondoanteprima.jpg') no-repeat;">
		...
		<tr>
			...
			<td width="400">
				<table border="0" width="400" cellpadding="0" cellspacing="0" style="font-family: Arial; font-size: 18px; font-weight: bold;">
					<tr>
						<td colspan="2" align="left">
							<? if($sesso=="f"){ print "Sign.ra ";}else{ print "Sig. ";} print utf8_decode($nome); ?>
						</td>
					</tr>
					<tr>
						<td colspan="2" align="left">Via: <? print utf8_decode(puliscitesto($via)); ?></td>
					</tr>
				</table>
				<table border="0" width="400" cellpadding="0" cellspacing="0" style="font-family: Arial; text-align: left; font-size: 18px; font-weight: bold;">			
					<tr>
						<td width="400"><? print $cap." ".utf8_decode(puliscitesto($paese))." ".utf8_decode($prov); ?></td>						
					</tr>
				</table>
				<table border="0" width="400"  cellpadding="0" cellspacing="0" style="font-family: Arial; font-size: 18px; font-weight: bold;">
					<tr>
						<td colspan="2" align="left">Tel.: <? print utf8_decode($tel); ?></td>
					</tr>
					<tr>
						<td colspan="2" align="left">E-mail: <? print utf8_decode($email); ?></td>
					</tr>
				</table>
			</td>
		</tr>
	</table>
	<table border="0" width="900" height="42" cellpadding="0" cellspacing="0" style="margin-left: 15px; background: url('../w-admin/immagini/riquadroprev.jpg') no-repeat; font-family: Arial; text-align: center; font-size: 18px; font-weight: bold;">
		<tr>
	...
	<table border="0" width="900" height="55" cellpadding="0" cellspacing="0" style="margin-left: 15px;  font-family: Arial; text-align: center; font-size: 14px;">
		<tr>
			<td width="330" style="background: url('../w-admin/immagini/riquadro1.jpg') no-repeat;"><? print "Prevista Consegna: ".$consegna;?></td>
			<td width="230" style="background: url('../w-admin/immagini/riquadro2.jpg') no-repeat;"><? print "Validità Offerta: ".$validita;?></td>
			<td width="340" style="background: url('../w-admin/immagini/riquadro3.jpg') no-repeat;"><? print $trasporto;?></td>
		</tr>
	</table>
...
<?				$queryprev=mysql_query("select * from preventivi where idpreventivo='".$idvisualizza."'") or die ("Query: prodotti non eseguita!");
				...
				while($data=mysql_fetch_array($queryprev)){
					...
					$nomeproddb=utf8_decode(@mysql_result($queryprod,0,1));
					$descproddb=utf8_decode(@mysql_result($queryprod,0,2));
...
?>					<div style="margin-bottom: 50px; overflow: hidden; width: 950px; height: <? if($cont>1){ print "1343px; background: url('../w-admin/immagini/sfondoanteprima.jpg') no-repeat; padding-top: 30px;";}else{ print "1034px;";}?>;">
					<table  border="0" width="900" cellpadding="0" cellspacing="0" style="font-family: Arial; margin-left: <? if($cont>1){ print "20px;";}else{ print "15px;";}?>">
						<tr>
							<td height="40" width="900" style="padding-left: 20px; padding-top: 10px; background: url('../w-admin/immagini/riquadro4.jpg') no-repeat;"><? print "<div style=\"float: left; width: 750px;\">".puliscitesto(strtoupper($nomemarcadb))." - ".puliscitesto($nomeproddb)."</div><div style=\"font-family: Arial; float: left; font-weight: bold;\">€. ".sistemaprezzo($prezzodb)."</div>"; ?></td>
						</tr>
						<tr>
...
?>								<td>
									...
									<div style="vertical-align: top; float: left;"><img src="../w-admin/immagini/frecciaprev.jpg"></div>
								</td>
<?							}else{ 
?>								<td valign="top" align="center"><img src="../w-admin/immagini/footerprev.jpg"></td>
<?							}								
?>						</tr>
					</table>
					</div>
