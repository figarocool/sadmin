...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "/w-admin/editor/images/";
		
		// Popups Directory
		this.PopupsDir = "/w-admin/editor/popups/";
		
		// CSS Directory File
		this.CSSFile = "/w-admin/editor/styles/wysiwyg.css";		
...
var WYSIWYG_ContextMenu = {
	...
	show: function(e, n) {
		...
		//this.contextMenuDiv.style.height = "150px";	
