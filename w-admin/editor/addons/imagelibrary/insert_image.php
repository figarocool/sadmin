...
<table width="380" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
	...
	<tr>
		...
		<td style="padding-bottom: 2px; padding-top: 0px;" width="300"><input type="text" name="src" id="src" value="<? if(strlen($_FILES['file']['name'])>0 and $upload==true){ print "/wp-content/plugins/carrello/editor/uploads/".$_FILES['file']['name'];} ?> "  style="font-size: 10px; width: 100%;"></td>
	</tr>
	<tr>
...
<tr>
	<td colspan="2" align="right" style="padding-top: 5px;">
		...
		<?php if ( $allowuploads ) { ?> 
			<input type="submit" value="  Upload  " style="font-size: 12px;" Onclick="chooser.location.href='select_image.php?dir=<?php echo $leadon; ?>'">
		<?php } ?> 		
