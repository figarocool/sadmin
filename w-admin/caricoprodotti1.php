...
?>							</select>
						...
						<td align="right">
							...
							<select name="listboxcategorie[]" id="listboxcategorie" multiple size="3" style="height: 100px; width: 210px;">
...
?>							</select>
				...
				<table style="width: 700px; font-family: Arial; margin-top: 30px; margin-bottom: 30px; background-color: #D5E2EB; position: relative; top: 0px;">
					<tbody id="lista_tutti_prodotti">
					<tr>
						<td height="50" id="prodotto_1">
							Misure: <br /><div id="aggiungi_nuova_misura" onclick="aggiungi_prodotto();"></div>
							L: <input type="text" name="prodottoNuovo[0][l]" id="l" value="<?php print $l; ?>" size="2"> P: <input type="text" name="prodottoNuovo[0][p]" id="p" value="<?php print $p; ?>"  size="2"> H: <input type="text" name="prodottoNuovo[0][h]" id="h" value="<?php print $h; ?>"  size="2"> D: <input type="text" name="prodottoNuovo[0][d]" id="d" value="<?php print $d; ?>"  size="2"> Nome: <input type="text" name="prodottoNuovo[0][nome_prod_tmp]" id="nome_prod" value="<?php print $nome_prod; ?>"  size="50">
						</td>
					</tr>
					</tbody>
				</table>
				...
				<div class="offerte">
					<?php if(strlen($prezzo)>0){?>
						<input type="radio" name="offerte" <? if($offerte=='0'){print 'checked="checked"';} ?> id="offerte" Onclick="javascript: document.getElementById('divanimato').style.display = 'none';" value="0"> Prodotto 
