...
function controllocampi(read){
	...
	if(document.richiesta.email.value=='' || document.richiesta.email.value=="Inserisci l'email!" && read==true){
		alert("L'email risulta vuota!");
		document.richiesta.email.focus();
		document.richiesta.email.style.border='2px solid #ff0000';
		document.richiesta.email.style.color='#ff0000';
		document.richiesta.email.value="Inserisci l'email!";
		return false;
	}
...
function formatto(read){
	...
	if(read=="7"){
		document.richiesta.email.style.border='1px solid #7F9DB9'; 
		document.richiesta.email.style.color='#000'; 
		document.richiesta.email.value='';
	}
}
function formatto1(read){
	if(document.richiesta.nome.value=="Inserisci il tuo nome!"){
		document.richiesta.nome.value='';
		document.richiesta.nome.style.border='1px solid #7F9DB9'; 
		document.richiesta.nome.style.color='#000'; 
	}
	if(document.richiesta.cognome.value=="Inserisci il tuo cognome!"){
 		document.richiesta.cognome.value='';
		document.richiesta.cognome.style.border='1px solid #7F9DB9'; 
		document.richiesta.cognome.style.color='#000'; 		
	}
	if(document.richiesta.paese.value=="Inserisci il paese!"){
		document.richiesta.paese.value='';
		document.richiesta.paese.style.border='1px solid #7F9DB9'; 
		document.richiesta.paese.style.color='#000'; 		
	}
	if(document.richiesta.prov.value=="Inserisci la provincia!"){
		document.richiesta.prov.value='';
		document.richiesta.prov.style.border='1px solid #7F9DB9'; 
		document.richiesta.prov.style.color='#000'; 		
	}
	if(document.richiesta.tel.value=="Inserisci un numero di telefono!"){
		document.richiesta.tel.value='';
		document.richiesta.tel.style.border='1px solid #7F9DB9'; 
		document.richiesta.tel.style.color='#000'; 		
	}
	if(document.richiesta.email.value=="Inserisci l'email!"){
		document.richiesta.email.value='';
		document.richiesta.email.style.border='1px solid #7F9DB9'; 
		document.richiesta.email.style.color='#000'; 		
	}
	if(document.richiesta.richiesta.value=="Inserisci la tua richiesta!"){
		document.richiesta.richiesta.value='';
		document.richiesta.richiesta.style.border='1px solid #7F9DB9'; 
		document.richiesta.richiesta.style.color='#000'; 		
	}
